...
public class ViewDragHelper {
     ...
     *
     * @param forParent Parent view to monitor
     * @param sensitivity  敏感数较大的值更为敏感。1.0f是正常的。Multiplier for how sensitive the helper should be about detecting
     *                    the start of a drag. Larger values are more sensitive. 1.0f is normal.
     * @param interpolator interpolator for scroller
     * @param cb Callback to provide information and receive events
     * @return a new ViewDragHelper instance
...
//                Log.e("action show","ACTION_DOWN");
                ...
                // Catch a settling view if possible. mCapturedView 是滑动的
                if (toCapture == mCapturedView && mDragState == STATE_SETTLING) {
//                    Log.e("ViewDragHelper","mCapturedViewyes");
                    tryCaptureViewForDrag(toCapture, pointerId);
                }else {
//                    Log.e("ViewDragHelper","mCapturedViewno");
                }
...
//                    Log.e("ViewDragHelper","从dragStarted=0滚动"+edgesTouched);
                }
                break;
            }

            case MotionEventCompat.ACTION_POINTER_DOWN: {
//                Log.e("action show","ACTION_POINTER_DOWN");
...
//                Log.e("action show","ACTION_MOVE");
                ...
                for (int i = 0; i < pointerCount && mInitialMotionX != null && mInitialMotionY != null; i++) {
                    ...
                    if (toCapture != null && checkTouchSlop(toCapture, dx, dy) &&
                            tryCaptureViewForDrag(toCapture, pointerId)) {
//                        Log.e("action show","tryCaptureViewForDrag");
                        break;
                    }
                }
                saveLastMotion(ev);
...
//                Log.e("action show","ACTION_POINTER_UP");
                final int pointerId = MotionEventCompat.getPointerId(ev, actionIndex);
        ...
        if(mDragState==STATE_DRAGGING){
//            Log.e("viewdraghelper","true");
        }else {
//            Log.e("viewdraghelper","false");
        }
