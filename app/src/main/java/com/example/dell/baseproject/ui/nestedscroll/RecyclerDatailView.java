...
public class RecyclerDatailView  extends LinearLayout  implements NestedScrollingParent {
    ...
    public RecyclerDatailView(Context context) {
        super(context);
    }

    public RecyclerDatailView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
