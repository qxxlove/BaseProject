...
import com.example.dell.baseproject.adapter.DataAdapter;
import com.example.dell.baseproject.bean.ItemModel;
import com.example.dell.baseproject.utils.AppToast;
...
public class RecyclerListViewActivity extends AppCompatActivity {
    ...
    private void initView() {
        mRecyclerView = (LRecyclerView) findViewById(R.id.lrcyListview);
    ...
    private class PreviewHandler extends Handler {
        ...
        private WeakReference<RecyclerListViewActivity> ref;

        PreviewHandler(RecyclerListViewActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final RecyclerListViewActivity activity = ref.get();
    ...
    private void requestData() {
        ...
        new Thread() {
            ...
            public void run() {
               ...
               /*//模拟一下网络请求失败的情况
                if(NetworkUtils.isNetAvailable(RecyclerListViewActivity.this)) {
                    mHandler.sendEmptyMessage(-1);
                } else {
