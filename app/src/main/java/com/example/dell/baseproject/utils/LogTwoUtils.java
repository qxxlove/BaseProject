...
/**
 * 描述 ：
 * 作者：Created by SEELE on 2017/8/29.
 * 邮箱：123123@163.com
 * http://www.jianshu.com/p/b806d014162c
 */

public class LogTwoUtils {
    ...
    public static class Builder {
        ...
        public Builder setLogSwitch(final boolean logSwitch) {
            LogTwoUtils.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setConsoleSwitch(final boolean consoleSwitch) {
            LogTwoUtils.sLog2ConsoleSwitch = consoleSwitch;
            return this;
        }

        public Builder setGlobalTag(final String tag) {
            if (isSpace(tag)) {
                LogTwoUtils.sGlobalTag = "";
                sTagIsSpace = true;
            } else {
                LogTwoUtils.sGlobalTag = tag;
                sTagIsSpace = false;
            }
            return this;
        }
        ...
        public Builder setLogHeadSwitch(final boolean logHeadSwitch) {
            LogTwoUtils.sLogHeadSwitch = logHeadSwitch;
            return this;
        }

        public Builder setLog2FileSwitch(final boolean log2FileSwitch) {
            LogTwoUtils.sLog2FileSwitch = log2FileSwitch;
            return this;
        }

        public Builder setDir(final String dir) {
            if (isSpace(dir)) {
                LogTwoUtils.dir = null;
            } else {
                LogTwoUtils.dir = dir.endsWith(FILE_SEP) ? dir : dir + FILE_SEP;
            }
            return this;
        }

        public Builder setDir(final File dir) {
            LogTwoUtils.dir = dir == null ? null : dir.getAbsolutePath() + FILE_SEP;
            return this;
        }

        public Builder setBorderSwitch(final boolean borderSwitch) {
            LogTwoUtils.sLogBorderSwitch = borderSwitch;
            return this;
        }

        public Builder setConsoleFilter(@TYPE final int consoleFilter) {
            LogTwoUtils.sConsoleFilter = consoleFilter;
            return this;
        }

        public Builder setFileFilter(@TYPE final int fileFilter) {
            LogTwoUtils.sFileFilter = fileFilter;
            return this;
        }
